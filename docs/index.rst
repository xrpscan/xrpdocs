.. xrpscan documentation master file, created by
   sphinx-quickstart on Fri Jun  7 04:19:12 2019.
...
We run a ``XRPL`` validator (`aloha.xrpscan.com 
<https://xrpscan.com/validator/nHDB2PAPYqF86j9j3c6w1F1ZqwvQfiWcFShZ9Pokg9q4ohNDSkAz>`_) 
that's included in Ripple's and Coil's recommended ``UNL``. We're committed to 
